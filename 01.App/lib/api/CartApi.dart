...
import 'package:petshop_app/model/Cart.dart';
import 'package:petshop_app/model/Order.dart';
import 'package:petshop_app/model/OrderDetail.dart';
...
import 'package:petshop_app/view/order/ordersuccess.dart';
...
class CartApi{
  ...
  static insert(int product_id,BuildContext context) async {
    SharedPreferences pref = await SharedPreferences.getInstance();
    int user_id = pref.getInt("id") ?? 0;
    var response = await http.MultipartRequest("POST",Uri.parse("${Apihelper.url_base}/cart/create"));
  ...
  static deleteone(int product_id,BuildContext context) async {
    SharedPreferences pref = await SharedPreferences.getInstance();
    int user_id = pref.getInt("id") ?? 0;
    var response = await http.MultipartRequest("POST",Uri.parse("${Apihelper.url_base}/cart/delete"));
    response.fields['product_id'] = product_id.toString();
    response.fields['user_id'] = user_id.toString();
    var statusres = await response.send();
    var responseData = await statusres.stream.toBytes();
  ...
  static deleteproduct(int product_id,BuildContext context) async {
    SharedPreferences pref = await SharedPreferences.getInstance();
    int user_id = pref.getInt("id") ?? 0;
    var response = await http.MultipartRequest("POST",Uri.parse("${Apihelper.url_base}/cart/deleteproduct"));
    response.fields['product_id'] = product_id.toString();
    response.fields['user_id'] = user_id.toString();
    var statusres = await response.send();
    var responseData = await statusres.stream.toBytes();
    ...
    SharedPreferences pref = await SharedPreferences.getInstance();
    int user_id = pref.getInt("id") ?? 0;
    var response = await http.MultipartRequest("POST",Uri.parse("${Apihelper.url_base}/huydon"));
  ...
  static orderproduct(String name, String phone, String address, String note ,BuildContext context) async {
    SharedPreferences pref = await SharedPreferences.getInstance();
    int user_id = pref.getInt("id") ?? 0;
    var response = await http.MultipartRequest("POST",Uri.parse("${Apihelper.url_base}/cart/order"));
    // response.fields['product_id'] = product_id.toString();
    response.fields['user_id'] = user_id.toString();
