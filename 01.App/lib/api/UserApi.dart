...
class UserApi {
  static uploadinfohaveimage(File image,BuildContext context) async {
    ...
    var response =  await http.MultipartRequest("POST",Uri.parse("${Apihelper.url_base}/changeimage"));
  ...
  static updateInfo(String name,  String phone , String address,BuildContext context) async {
    SharedPreferences pref = await SharedPreferences.getInstance();
    var response =  await http.MultipartRequest("POST",Uri.parse("${Apihelper.url_base}/changeinfo"));
