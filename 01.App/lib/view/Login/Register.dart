...
class _Register extends State<Register> {
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: TextButton(onPressed: () {
                        if(fname.text!="" &&lname.text!="" &&email.text!="" &&password.text!="" &&c_password.text!="" ){
                            if(password.text==c_password.text){
                              signUp(fname.text, lname.text, email.text, password.text, c_password.text);
  ...
  signUp(String fname, String lname, String email, String password,
    ...
    var response = await http.post(
        Uri.parse('${Apihelper.url_base}/register'), body: data);
