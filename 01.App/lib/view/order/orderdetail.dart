        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: FutureBuilder(
                  future: orders,
                  builder:(BuildContext context, AsyncSnapshot<List<OrderD>>snapshot){
                    if(snapshot.hasData){
                                                        ...
                                                        Column(
                                                          children: [
                                                            Container(
                                                              ...
                                                              child: Text("${Apihelper.money(muanhieu[index].price)}",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18,color: Colors.black),),),
                                                            Container(
                                                              padding: EdgeInsets.only(left:5,top: 10),
                                                              child: Text("Số lượng ${muanhieu[index].quantity}",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18,color: Colors.black),),),
                                                          ],
                                                        ),

                                                        Container(
                                                          padding: EdgeInsets.only(left: 5),
                                                          child: Text("${Apihelper.money(muanhieu[index].price*muanhieu[index].quantity)}",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18,color: Colors.deepOrange),),),
