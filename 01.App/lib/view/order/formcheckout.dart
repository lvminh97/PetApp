...
import 'package:petshop_app/api/CartApi.dart';
...
TextEditingController note  = new TextEditingController();
 ...
 void checktotal ()async{
   ...
   setState(() {
     total_cart = pref.getInt("total_cart") ?? 0;
            ...
            Align(
              ...
              child: InkWell(
                child: Container(
                  ...
                  child: Center(child: Text("TIẾN HÀNH ĐẶT HÀNG",style: TextStyle(fontSize: 17,fontWeight: FontWeight.bold,color: Colors.white),)),
                ),
                onTap: (){
                  if (namec.text!=""&&phone.text!=""&&address.text!=""&&note.text!=""){
                    CartApi.orderproduct(namec.text,phone.text, address.text, note.text, context);
                  }
                  else {
                    ...
                    child: Column(
                      children: [
                        Padding(
                          ...
                          child: Text("THÔNG TIN ĐẶT HÀNG",style: TextStyle(fontWeight: FontWeight.w700,fontSize: 20,color:Colors.deepOrangeAccent),),
                        ),
                        SizedBox(height: 40,),
                        TextFormField(
                            controller: namec,
                            ...
                            obscureText: false,
                            decoration: InputDecoration(
                              contentPadding: EdgeInsets.only(bottom: -9,left: 13,right: 13),
                              hintText:"Họ và tên",
                              hintStyle: TextStyle(color: Colors.grey,fontFamily: 'Roboto',fontSize: 13),
                              border: OutlineInputBorder(
                              ...
                              focusedBorder:OutlineInputBorder(
                                borderSide: const BorderSide(color: Color.fromRGBO(243, 98, 105, 1), width: 2.0),
                        ...
                        Text("Tổng tiền : ${Apihelper.money(total_cart)}",style: TextStyle(fontSize: 20,color: Colors.deepOrange,fontWeight: FontWeight.bold),)
                      ],
                    ),
                    )
