...
import 'package:petshop_app/view/order/orderdetail.dart';
        ...
        child: Column(
          children: [
            Padding(
              ...
              child: Text("Đơn hàng",style: TextStyle(color: Color.fromRGBO(227, 67, 67,
                            ...
                            return RefreshIndicator(
                                child: ListView.builder(
                                    ...
                                    itemBuilder: (BuildContext context,index){
                                      return InkWell(
                                        onTap: (){
                                          Navigator.push(context, MaterialPageRoute(builder:(context) =>OrderDetail(tatcasanpham[index].id,)));
                                        },
                                        child: Container(
                                            ...
                                            children: [
                                              Container(
                                                ...
                                                child:  Row(
                                                    ...
                                                    children: [
                                                      Text("${tatcasanpham[index].name}"),
                                                      Text(Apihelper.money(tatcasanpham[index].total_price))
                                                    ],
                                                  )
                                              ...
                                              Container(
                                                  ...
                                                  child: Text("${tatcasanpham[index].phone}",
                                                    style: TextStyle(fontWeight: FontWeight.bold,color:Colors.pink),)),
                                              SizedBox(height: 20,),
                                              Container(
                                                  padding: EdgeInsets.only(left: 20),
                                                child: Text("${tatcasanpham[index].address}",
                                                style: TextStyle(fontWeight: FontWeight.bold,color:Colors.pink),)),SizedBox(height: 20,),
                                              Container(
                                                  padding: EdgeInsets.only(left: 20,bottom: 20),
                                                child: Text("${tatcasanpham[index].note}",
                                                style: TextStyle(fontWeight: FontWeight.bold,color:Colors.pink),)),
                                              ...
                                              Container(
                                                  ...
                                                  child:  Row(
                                                    ...
                                                    children: [
                                                      Container(
                                                        padding: EdgeInsets.only(left: 20,bottom: 20),
                                                        child: (Text("${tatcasanpham[index].status}",
                                                          style: TextStyle(fontWeight: FontWeight.bold,color:Colors.pink),)),),
                                                      if(tatcasanpham[index].status=="Đang xử lý")TextButton(onPressed: (){
                                                        CartApi.huydon(tatcasanpham[index].id, context);
