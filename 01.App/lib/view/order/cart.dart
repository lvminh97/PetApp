...
import 'package:petshop_app/view/order/formcheckout.dart';
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      Container(
                                                          ...
                                                          child: Text("${Apihelper.money(muanhieu[index].price)}",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18,color: Colors.deepOrange),),),
                                                      InkWell(child: Icon(Icons.delete,color: Colors.red,),
                                                      onTap: (){
                                                        CartApi.deleteproduct(muanhieu[index].product_id,   context);
                                                      },
                                                      ),
                                                    ],
                                                  ),
                                                    ...
                                                    Row(
                                                      children: [
                                                        InkWell(
                                                          ...
                                                          onTap: (){
                                                            CartApi.deleteone(muanhieu[index].product_id, context);
                                                          },
                                                        ),
                                                        SizedBox(
                                                          width: 10,
                                                        ),
                                                        if(muanhieu[index].quantity<10)Text(
                                                        ...
                                                        InkWell(
                                                          ...
                                                          onTap: (){
                                                            CartApi.insert(muanhieu[index].product_id, context);
                                                          },
                                                        ),
                                                      ],
                                                    )
            ...
            if(checkcart==true)Align(
              ...
              child: InkWell(
                child: Container(
                  ...
                  child: Center(child: Text("ĐẶT HÀNG",style: TextStyle(fontSize: 17,fontWeight: FontWeight.bold,color: Colors.white),)),
                ),
                onTap: (){
