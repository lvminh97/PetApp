                      ...
                      width: 390,
                          child: Column(
                            children: [
                              ...
                              Text("BẠN ĐÃ ĐẶT HÀNG THÀNH CÔNG",style: TextStyle(fontSize: 20,color: Colors.red,fontWeight: FontWeight.bold),),
                             SizedBox(height: 30,),
                              Text("Petshop chân thành cảm ơn !",style: TextStyle(fontSize: 20,color: Colors.red),)
                            ],
                          ),
                    )
            ...
            Align(
              ...
              child: InkWell(
                child: Container(
                  ...
                  child: Center(child: Text("VỀ TRANG CHỦ",style: TextStyle(fontSize: 17,fontWeight: FontWeight.bold,color: Colors.white),)),
                ),
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder:(context) =>Home()));
                },
