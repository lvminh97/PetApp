...
import 'package:petshop_app/model/User.dart';
...
import 'package:petshop_app/view/User/Changinfo.dart';
        ...
        children: [
          ...
          Container(
            ...
            child: Row(children: [
              Container(
                width: 150,
                child: Text("Họ tên:",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
              ),Container(
          ...
          Container(
            ...
            child: Row(children: [
              Container(
                width: 150,
                child: Text("Số điện thoại",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
              ),Container(
                child: Text((phone!=null)?"$phone":"",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
         ...
         SizedBox(height: 30,),
          Container(
            ...
            child: Row(children: [
              Container(
                ...
                child: Text((email!=null)?"$email":"",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
          ...
          Container(
            ...
            child: Row(children: [
              Container(
                width: 150,
                child: Text("Địa chỉ",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
              ),
              Container(
                child: Text((address!=null)?"$address":"",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
          ...
          TextButton(onPressed: (){
            Navigator.push(context, MaterialPageRoute(builder:(context) =>Changinfo()));
